...
import com.sda.bookstore.project.repository.OrderRepository;
import com.sda.bookstore.project.service.CartItemService;
import com.sda.bookstore.project.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public synchronized Order createOrder(ShoppingCart shoppingCart, ShippingAddress shippingAddress,
                                          BillingAddress billingAddress, Payment payment, String shippingMethod,
                                          User user) {
